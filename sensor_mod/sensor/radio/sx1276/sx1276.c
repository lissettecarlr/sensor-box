 ...
 */
static RadioEvents_t *SX1276Events = NULL;
...
static bool SX1276Initialized = false;
...
void SX1276Init( RadioEvents_t *events )
{
    ...
    if( SX1276Initialized == false )
    {
        // Initialize driver timeout timers
        TimerInit( &TxTimeoutTimer, SX1276OnTimeoutIrq, "tx timeout" );
        TimerInit( &RxTimeoutTimer, SX1276OnTimeoutIrq, "rx timeout" );
        TimerInit( &RxTimeoutSyncWord, SX1276OnTimeoutIrq, "rx syncword timeout" );
...
void SX1276OnTimeoutIrq( void )
{
    ...
    case RF_RX_RUNNING:
        ...
        if( ( SX1276Events != NULL ) && ( SX1276Events->RxTimeout != NULL ) )
        {
            SX1276Events->RxTimeout( );
        }
        break;
    case RF_TX_RUNNING:
        ...
        SX1276.Settings.State = RF_IDLE;
        if( ( SX1276Events != NULL ) && ( SX1276Events->TxTimeout != NULL ) )
        {
            SX1276Events->TxTimeout( );
        }
        break;
    default:
        break;
...
void SX1276OnDio0Irq( void )
{
    ...
    switch( SX1276.Settings.State )
    {
            ...
            case MODEM_FSK:
                if( SX1276.Settings.Fsk.CrcOn == true )
                {
                    ...
                    if( ( irqFlags & RF_IRQFLAGS2_CRCOK ) != RF_IRQFLAGS2_CRCOK )
                    {
                        ...
                        if( ( SX1276Events != NULL ) && ( SX1276Events->RxError != NULL ) )
                        {
                            SX1276Events->RxError( );
                        }
                        SX1276.Settings.FskPacketHandler.PreambleDetected = false;
                        SX1276.Settings.FskPacketHandler.SyncWordDetected = false;
                        SX1276.Settings.FskPacketHandler.NbBytes = 0;
                ...
                if( ( SX1276Events != NULL ) && ( SX1276Events->RxDone != NULL ) )
                {
                    SX1276Events->RxDone( RxTxBuffer, SX1276.Settings.FskPacketHandler.Size, SX1276.Settings.FskPacketHandler.RssiValue, 0 );
                }
                SX1276.Settings.FskPacketHandler.PreambleDetected = false;
                SX1276.Settings.FskPacketHandler.SyncWordDetected = false;
                SX1276.Settings.FskPacketHandler.NbBytes = 0;
            ...
            case MODEM_LORA:
                {
                    ...
                    if( ( SX1276Events != NULL ) && ( SX1276Events->RxDone != NULL ) )
                    {
                        SX1276Events->RxDone( RxTxBuffer, SX1276.Settings.LoRaPacketHandler.Size, SX1276.Settings.LoRaPacketHandler.RssiValue, SX1276.Settings.LoRaPacketHandler.SnrValue );
                    }
                }
                break;
            default:
        ...
        case RF_TX_RUNNING:
            ...
            default:
                SX1276.Settings.State = RF_IDLE;
                if( ( SX1276Events != NULL ) && ( SX1276Events->TxDone != NULL ) )
                {
                    SX1276Events->TxDone( );
                }
                break;
        ...
        case RF_RX_RUNNING:
            ...
            case MODEM_LORA:
                if( SX1276.Settings.LoRa.FreqHopOn == true )
                {
                    ...
                    if( ( SX1276Events != NULL ) && ( SX1276Events->FhssChangeChannel != NULL ) )
                    {
                        SX1276Events->FhssChangeChannel( ( SX1276Read( REG_LR_HOPCHANNEL ) & RFLR_HOPCHANNEL_CHANNEL_MASK ) );
                    }
                }
                break;
            default:
...
void SX1276OnDio3Irq( void )
{
    ...
    case MODEM_LORA:
        if( ( SX1276Read( REG_LR_IRQFLAGS ) & RFLR_IRQFLAGS_CADDETECTED ) == RFLR_IRQFLAGS_CADDETECTED )
        {
            ...
            if( ( SX1276Events != NULL ) && ( SX1276Events->CadDone != NULL ) )
            {
                SX1276Events->CadDone( true );
            }
        }
        else
        {
